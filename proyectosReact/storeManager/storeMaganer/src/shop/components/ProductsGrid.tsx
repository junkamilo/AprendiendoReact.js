...
import type { Product } from "@/mooks/products.mook"
...
export const ProductsGrid = ({products}:Props) => {
    ...
    const hanledViewModeChange = (mode: 'grid'| 'list')=>{
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <div className="hidden md:flex border rounded-md">
                            <Button
                                ...
                                size="sm"
                                onClick={() => hanledViewModeChange('grid')}
                            ...
                            <Button
                                ...
                                size="sm"
                                onClick={() => hanledViewModeChange('list')}
